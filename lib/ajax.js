...
chassis(function (q, global) {
 ...
 // Prerequisites (n/a)
    ...
    if (q.detects("location") === false) {
     // If this implementation isn't a web browser, AJAX is inappropriate.
        return;
    }

    if (global.location.protocol === "file:") {
     // AJAX _can_ run over "file:", but it's tricky ...
        throw new Error('The "ajax" module cannot run over "file:" yet.');
    }
