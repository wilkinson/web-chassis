 ...
 // Module definition
    ...
    q.base = function () {
     ...
     // Declarations
        ...
        var a$indexOf, a$ply, duck, generic, guts, key_gen, known_types,
            index_of;
     ...
     // Definitions
        ...
        guts = function () {
         ...
         // to offer some helpful debugging advice. (This may be removed ...)
            temp = [];
            a$ply(args, function (key, val) {
                temp[key] = Function;   //- a "map-along" pattern :-P
            });
        ...
        key_gen = function (x) {
            ...
            a$ply(x, function (key, val) {
             // We map on one return variable and reduce on the other :-)
